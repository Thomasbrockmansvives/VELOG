...
class Route:
    ...
    def __init__(self, start, destination, type_id, length_km):
        try:
            ...
            print(
                f"Error when creating a new route. Invalid use of value: {err}")
    ...
    def get_by_id(cls, route_id):
        ...
        try:
            ...
            print(
                f"That route does not exist. Please use an existing route id: {err}")
    ...
    def calculate_averages(cls, route_id):
        ...
        try:
            with sqlite3.connect(db_root_path) as connection:
                ...
                print(f"Updated route {route_id}: average_score={
                      round(average_score, 2)}, average_time_minutes={int(round(average_duration))}")
