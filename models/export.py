    ...
    def export_all_routes(cls):
        ...
        try:
            with open(csv_file_path, 'w', newline='') as file:
                ...
                header = ['id', 'start', 'destination', 'type',
                          'length_km', 'average_score', 'average_time_minutes']
            ...
            print()
            print(
                "Export succesful. Please find the export of all routes in the Export folder.")
            print()
    ...
    def export_all_rides(cls):
        ...
        try:
            with open(csv_file_path, 'w', newline='') as file:
                ...
                header = ['date', 'start_time', 'end_time', 'score', 'weather', 'start',
                          'destination', 'route', 'type', 'length_km', 'version', 'average_route_score']
                writer.writerow(header)
            ...
            print()
            print(
                "Export succesful. Please find the export of all rides in the Export folder.")
            print()
