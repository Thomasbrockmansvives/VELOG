...
class Ride:
    ...
    def update(self, ride_id, route_id, date, start_time, end_time, score, weather_id):
        ...
        try:
            ...
            print(
                f"That ride does not exist. Please use an existing ride id: {err}")
    ...
    def get_by_id(cls, ride_id):
        ...
        try:
            with sqlite3.connect(db_root_path) as connection:
                ...
                ride_object = Ride(
                    ride[1], ride[2], ride[3], ride[4], ride[5], ride[6])
    ...
    def get_rides_by_route_id(cls, route_id):
        ...
        try:
            ...
            print(
                f"That route doesn't exist. Please use an existing route id: {err}")
